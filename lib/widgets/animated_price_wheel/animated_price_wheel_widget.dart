...
import 'animated_number_wheel_widget.dart';

class AnimatedPriceWheelWidget extends StatefulWidget {
  ...
  @override
  State<AnimatedPriceWheelWidget> createState() => _AnimatedPriceWheelWidgetState();
}

class _AnimatedPriceWheelWidgetState extends State<AnimatedPriceWheelWidget> {
    ...
    return Row(
      ...
      children: [
        ...
        ...List.generate(
          ...
          :
          AnimatedNumberWheelWidget(number: numbers[index])
        ),
      ]
    );
  }
